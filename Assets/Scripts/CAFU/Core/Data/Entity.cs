...
namespace CAFU.Core.Data {
    ...
    /// <typeparam name="TEntity">要素の型</typeparam>
    public interface IListEntity<TEntity> : IEntity, IList<TEntity> where TEntity : IEntity {
    ...
    public interface IMapEntity : IEntity, IDictionary {
    ...
    /// 辞書型の Entity インタフェース
    /// </summary>
    /// <remarks>実装クラス側で実装することで Entity を Dictionary 的に参照出来るようにする</remarks>
    ...
    public interface IMapEntity<TKey, TValue, TKeyValuePair> : IEntity, IDictionary<TKey, TValue> where TValue : IEntity where TKeyValuePair : Application.Utility.IKeyValuePair<TKey, TValue> {
    ...
    /// </summary>
    /// <typeparam name="TEntity">要素の型</typeparam>
    public abstract class ListEntityBase<TEntity> : IListEntity<TEntity>, IListEntity where TEntity : IEntity, new() {
        ...
        public List<TEntity> List {
            get {
                if (this.list == default(List<TEntity>)) {
        ...
        public int Add(object value) {
            this.List.Add((TEntity)value);
            return this.List.IndexOf((TEntity)value);
        }
        ...
        public bool Contains(object value) {
            return this.List.Contains((TEntity)value);
        }
        ...
        public void CopyTo(Array array, int index) {
            this.List.CopyTo((TEntity[])array, index);
        }
        ...
        public void Insert(int index, object value) {
            this.List.Insert(index, (TEntity)value);
        }
        ...
        public void Remove(object value) {
            this.List.Remove((TEntity)value);
        }
    ...
    /// 辞書型の Entity 基底クラス
    /// </summary>
    /// <remarks>シリアライズ不要な場合はコチラを用いる</remarks>
    /// <typeparam name="TKey">辞書のキーの型</typeparam>
    /// <typeparam name="TValue">辞書の値の型</typeparam>
    public abstract class MapEntityBase<TKey, TValue> : MapEntityBase<TKey, TValue, Application.Utility.KeyValuePair<TKey, TValue>>
        where TValue : IEntity, new() {
    ...
    /// <typeparam name="TValue">辞書の値の型</typeparam>
    /// <typeparam name="TKeyValuePair">辞書の KeyValuePair の型</typeparam>
    public abstract class MapEntityBase<TKey, TValue, TKeyValuePair> : IMapEntity<TKey, TValue, TKeyValuePair>, IMapEntity
        where TValue : IEntity, new()
        where TKeyValuePair : class, Application.Utility.IKeyValuePair<TKey, TValue>, new() {
